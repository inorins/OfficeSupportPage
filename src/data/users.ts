...
export const mockUsers: AppUser[] = [
  ...
  {
    id: 'u-inorins-2',
    name: 'Sujan Prajapati',
    email: 'sujan@inorins.com',
    password: 'demo123',
    role: 'inorins',
  ...
  {
    id: 'u-inorins-3',
    name: 'Maheshwor Prajapati',
    email: 'maheshwor@inorins.com',
    password: 'demo123',
    role: 'inorins',
    title: 'Support Engineer',
  },
  {
    id: 'u-inorins-4',
    name: 'Ramendra Pradhananga',
    email: 'ramendra@inorins.com',
    password: 'demo123',
    role: 'inorins',
    title: 'Support Engineer',
  },
